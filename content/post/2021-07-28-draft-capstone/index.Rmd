...
![Presumed houseless individual holding sign](homelessness-sign.jpg) 
...
```{r}
#knitr::opts_chunk$set(echo = TRUE,fig.width = 12,fig.height = 4)
deliver <- ggplot(wherer, aes(Month, Count, color=Location)) +
  geom_point()+
   labs(x = "Month",
       y= "Food Distribtions", 
       title= "Monthly Food Distribution from the Clackamas Service Center",
...
```{r}
#knitr::opts_chunk$set(echo = TRUE,fig.width = 12,fig.height = 4)
ggplot(clientSer, aes(Month, Count, color=Client_Service)) +
  geom_line()+
   labs(x = "Recorded Month",
       y= "Lbs of Food Distributed", 
       title= "Monthly Food Distribution from the Clackamas Service Center",
       subtitle = "To all food programs",
       caption = "Data provided July 2021")
